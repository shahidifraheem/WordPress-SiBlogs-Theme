...
/**
 * The post overlay content template part file
 *
 * @package WordPress
 * @subpackage SI_Blogs
 * @since SI Blogs 1.0
 */
?>
<div class="overlay-post overlay-post-<?= get_the_ID(); ?>">
    <a href="<?php the_permalink(); ?>" class="link-overlay"></a>
    <?php if (has_post_thumbnail()) : ?>
        <div class="featured-img">
            <img src="<?= wp_get_attachment_url(get_post_thumbnail_id(get_the_ID())); ?>" alt="<?php the_title(); ?>">
        </div>
    <?php endif; ?>
